            ...
            for i in [-1,0,1]:
                for j in [-1,0,1]:
                    for k in [-1,0,1]:
                        ...
                        if (cell[0] + i, cell[1] + j, cell[2] + k ) not in universe:

                            potential_new_neighbors.add((cell[0] + i, cell[1] + j, cell[2] + k))
                        #ignore itself.
                        if i == j == k == 0:
                            pass
                        elif (cell[0] + i, cell[1] + j, cell[2] + k ) in universe:
                            live_neighbors += 1
                ...
                for j in [-1,0,1]:
                    for k in [-1,0,1]:
                        ...
                        if i == j == k == 0:
                            pass
                        #don't count cell.
                        if (cell[0] + i, cell[1] + j, cell[2] + k ) in universe:
                            live_neighbors += 1
            if live_neighbors == 3:
                        universe_next_tick.add(cell)
